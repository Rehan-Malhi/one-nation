      ...
      <div className="mx-auto max-w-8xl px-4 sm:px-6 lg:px-8">
        <div className="overflow-hidden h-full rounded-2xl bg-white shadow-[0_25px_80px_-40px_rgba(0,0,0,0.45)]">
          <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className="flex w-full text-white items-center justify-between gap-4 text-left"
                      >
                        <span className="text-lg font-extrabold text-gray-300 sm:text-xl">
                          {item.title}
                        </span>

                        <span className="flex h-9 w-9 items-center justify-center rounded-full text-3xl font-md text-black">
                          {isOpen ? "–" : "+"}
                        </span>
                      </button>
            ...
            {/* RIGHT */}
            <div className="relative lg:pt-0 w-full min-h-[680px] bg-red-800 lg:min-h-[920px]">
              <img
                src="/mock.png" // <-- replace with your image
